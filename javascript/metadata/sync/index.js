...
var app = new Vue({
    ...
    methods: {
        ...
        syncFunc() {
            if (that.isSyncYu) {
                synInfo.nodes = that.syncYuNodes
                synInfo.sourceNode = that.syncYuSourceNode
                synInfo.nodeForCode = that.syncYuNodeCode
                that.isSyncYu = false
            }
            else {
