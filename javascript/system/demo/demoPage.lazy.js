...
LazyDemoPage = {
    ...
    load: function () {
        ...
        $(".sidebar-menu .demo_4").addClass("active");  //点亮当前页面的菜单项
        ...
        LazyDemoPage.showPage(firstPage, defaultPageSize);
    }
    ...
    , setPagination: function (pageSize, currentPage, totalSize) {
        ...
        $("#pagination").Paging({
            ...
            callback: function (page, size, count) {
                ...
                LazyDemoPage.showPage(page, size);
            }
        });
    }
    ...
    , showPage: function(currentPage, selectedSize) {
        ...
        var url = "/demo_4/" + pageSize + "/" + currentPage;
